...
static void (*isr_rx)(void) = NULL;

/**
 * Configura la UART.
 * @param baud Velocidad en bps
 * @param isr_rx Puntero a la función de interrupción para la recepción.
 */
void configUART(uint16_t baud, void (*isr_rx)(void))
{
